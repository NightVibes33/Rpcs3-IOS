...
{
// Keep the primitive record available to pure C++ translation units such as
// the upstream runtime bridge. The numeric value is an MTLPrimitiveType when
// consumed by Objective-C++ code.
struct primitive_mapping
{
    std::uint32_t primitive = 3; // MTLPrimitiveTypeTriangle
