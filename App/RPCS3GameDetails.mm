...
- (void)bootGame {
    ...
    [self.navigationController pushViewController:[[RPCS3LaunchSessionController alloc] initWithEntry:self.entry] animated:YES];
}
@end
